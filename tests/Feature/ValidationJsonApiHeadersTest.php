...
class ValidationJsonApiHeadersTest extends TestCase
{
    ...
    /** @test */
    public function accept_header_mus_bet_present_in_all_requests()
    {
    ...
    /** @test */
    public function content_type_header_mus_bet_present_in_all_post_requests()
    {
    ...
    /** @test */
    public function content_type_header_mus_bet_present_in_all_patch_requests()
    {
